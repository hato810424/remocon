...
import { Container, Group, Button, Stack, Paper, Title, Text, ActionIcon, Slider } from '@mantine/core'
...
export default function App() {
  ...
  const [strips, setStrips] = useState<Array<{gain: number}>>([
    { gain: 0 }, // Strip 1
    { gain: 0 }, // Strip 2
    { gain: 0 }, // Strip 3
  ]);
          ...
          <Stack gap="sm">
            ...
            {strips.map((strip, index) => (
              <div key={index}>
                ...
                <Slider
                  // value={strip.gain}
                  onChange={(value) => handleGainChange(value, index)}
                  min={-60}
                  max={12}
                  step={0.1}
